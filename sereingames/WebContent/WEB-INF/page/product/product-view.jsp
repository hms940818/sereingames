...
<c:choose>
	<c:when test="${webDto.spFlg}">
		<!-- 手机版 -->
		<link rel="stylesheet" type="text/css" href="/sereingames/resource/sp/product/css/product.css">
		<script type="text/javascript" src="/sereingames/resource/sp/product/js/product.js"></script>
	</c:when>
	<c:otherwise>
		<!-- 电脑版 -->
		<!-- css -->
		<link rel="stylesheet" type="text/css" href="/sereingames/resource/product/css/product.css">
		...
		<script type="text/javascript" src="/sereingames/resource/product/js/product.js"></script>
	</c:otherwise>
</c:choose>
</head>
...
<!-- 大图片显示区域 START -->
<div class="ny_banner" style="background:url(/sereingames/resource/common/img/hengfu.jpg) no-repeat center;width: 100%; height: 250px;overflow: hidden;">
	<div class="container">
		<!-- 页面大标题 -->
		<h1>
...
<c:set var="jspName" value="./includeJsp/productIncludeView${webDto.id }.jsp"></c:set>
