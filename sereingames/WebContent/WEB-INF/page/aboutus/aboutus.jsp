...
<c:choose>
	<c:when test="${webDto.spFlg}">
		<!-- 手机版 -->
		<link rel="stylesheet" type="text/css" href="/sereingames/resource/sp/aboutus/css/aboutus.css">
		<script type="text/javascript" src="/sereingames/resource/sp/aboutus/js/aboutus.js"></script>
	</c:when>
	<c:otherwise>
		<!-- 电脑版 -->
		<!-- css -->
		<link rel="stylesheet" type="text/css" href="/sereingames/resource/aboutus/css/aboutus.css">
		...
		<script type="text/javascript" src="/sereingames/resource/aboutus/js/aboutus.js"></script>
	</c:otherwise>
</c:choose>
</head>
